...
export const sampleTestimonials: Testimonial[] = [
  ...
  },
  {
    ...
    authorCompany: "Deskflow",
    authorPhoto: "https://api.dicebear.com/7.x/avataaars/svg?seed=james",
    text: "We've tried half a dozen social proof tools. Laudica is the only one that treats testimonials as conversion assets, not just a library to organize.",
    rating: 5,
    tags: ["trust", "results"],
  },
  {
