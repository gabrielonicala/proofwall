...
export const sampleTestimonials: Testimonial[] = [
  {
    ...
    text: "ProofWall completely transformed our conversion rate. We went from a generic testimonials page to contextual social proof on every key page. Our pricing page alone saw a 34% lift.",
    rating: 5,
  ...
  },
  {
    ...
    text: "We embedded ProofWall on our pricing page and saw demo requests jump 28% in the first month. The ROI is absurd for the price.",
    rating: 5,
    tags: ["results", "pricing"],
  },
  {
  ...
  },
  {
    ...
    text: "The embed widget is incredibly lightweight. No layout shift, no performance hit. Our Lighthouse scores didn't budge after adding ProofWall to every page.",
    rating: 5,
    tags: ["features", "speed"],
  },
  {
    ...
    text: "We've tried Senja, Testimonial.to, and three others. ProofWall is the only one that treats testimonials as conversion assets, not just a library to organize.",
    rating: 5,
    tags: ["trust", "results"],
  },
  {
